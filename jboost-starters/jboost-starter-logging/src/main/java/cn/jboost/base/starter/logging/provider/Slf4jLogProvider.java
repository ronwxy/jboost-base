package cn.jboost.base.starter.logging.provider;

import cn.jboost.base.starter.logging.util.LogUtil;
 ...
 * @Version 1.0
 */
public class Slf4jLogProvider implements ILogProvider {
