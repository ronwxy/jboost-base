package cn.jboost.base.starter.alioss;
...
import cn.jboost.base.common.util.ContentTypeUtil;
import cn.jboost.base.common.util.FileUtil;
...
public class AliOssManager {
     ...
     * @throws IOException
     */
    public String fileSave(String bizType, MultipartFile mf, String fileName) throws IOException {
        // 获取文件名
        String orgName = mf.getOriginalFilename();
        String fileExt = FileUtil.getExtensionName(orgName);
        String dbPath = bizType + File.separator + fileName + "." + fileExt;
        if (dbPath.contains("\\")) {
    ...
    public String fileSave(String bizType, MultipartFile mf) throws IOException {
        return fileSave(bizType, mf, IdUtil.simpleUUID());
    }
     ...
     * @throws IOException
     */
    public String fileSave(String bizType, File file, String fileName) {
    ...
    public String fileSave(String bizType, File file) {
        return fileSave(bizType, file, IdUtil.simpleUUID());
    }
}
